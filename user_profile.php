...
if(isset($_POST['update_profile'])){
   ...
   $check_email = mysqli_query($conn, "SELECT * FROM `users` WHERE email = '$email' AND id != '$user_id'") or die('query failed');
...
if(isset($_POST['update_password'])){
   ...
   // Verify old password
   $verify_pass = mysqli_query($conn, "SELECT * FROM `users` WHERE id = '$user_id' AND password = '$old_password'") or die('query failed');
   ...
   <div class="profile-container">
      ...
      <form method="post" class="profile-section">
         ...
         <div class="form-group">
            ...
            <input type="text" id="name" name="name" value="<?php echo $user_data['name']; ?>" class="box" required>
         </div>
         <div class="form-group">
            <label for="email">Email Address</label>
            <input type="email" id="email" name="email" value="<?php echo $user_data['email']; ?>" class="box" required>
         </div>
